...
const CYBER_RESULTS_ROWS: CyberResultsRow[] = [
  ...
  },
  {
    ...
    kind: "scenario",
    groupId: "CR-001",
    name: "Ransomware attack on Payment gateway",
    impact: { numeric: "5", label: "Very high", rag: "neg05" },
    threat: { numeric: "4", label: "High", rag: "neg03" },
    vulnerability: { numeric: "5", label: "Very high", rag: "neg05" },
  ...
  },
  {
    ...
    kind: "scenario",
    groupId: "CR-001",
    name: "Ransomware attack on Customer database",
    impact: { numeric: "5", label: "Very high", rag: "neg05" },
    threat: { numeric: "4", label: "High", rag: "neg03" },
    vulnerability: { numeric: "5", label: "Very high", rag: "neg05" },
    likelihood: { numeric: "20", label: "High", rag: "neg03" },
  ...
  },
  {
    ...
    kind: "scenario",
    groupId: "CR-002",
    name: "Phishing campaign on Email server",
    impact: { numeric: "4", label: "High", rag: "neg03" },
  ...
  },
  {
    ...
    kind: "scenario",
    groupId: "CR-002",
    name: "Phishing campaign on Social media accounts",
